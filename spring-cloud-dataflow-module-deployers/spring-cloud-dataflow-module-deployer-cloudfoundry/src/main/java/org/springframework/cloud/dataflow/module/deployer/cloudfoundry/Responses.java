...
class Responses {
	...
	/**
	 * Response from REST operation {@link CloudControllerOperations#getApplicationEnvironment(Requests.GetApplicationEnvironment) getApplicationEnvironment()}.
	 */
	...
	static class ApplicationInstanceStatus {
		...
		public ApplicationInstanceStatus withState(String state) {
			this.state = state;
			return this;
		}
		...
		@JsonProperty("stats")
		public ApplicationInstanceStatus withStatistics(Statistics statistics) {
		...
		static class Statistics {
			...
			public Statistics withUsage(Usage usage) {
				this.usage = usage;
				return this;
			}
			...
			public Statistics withUris(List<String> uris) {
				this.uris = uris;
				return this;
			}
			...
			public Statistics withHost(String host) {
				this.host = host;
				return this;
			}
			...
			public Statistics withPort(Integer port) {
				this.port = port;
				return this;
			}
			...
			public Statistics withUptime(Integer uptime) {
				this.uptime = uptime;
				return this;
			}
			...
			public Statistics withMemoryQuota(Integer memoryQuota) {
			...
			public Statistics withDiskQuota(Integer diskQuota) {
			...
			public Statistics withFdsQuota(Integer fdsQuota) {
